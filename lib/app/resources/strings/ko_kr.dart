...
final koKr = {
  ...
  StringRes.emailDuplicated: "이미 등록된 이메일입니다.",
  StringRes.password: "비밀번호",
  StringRes.passwordHint: "영문+특수문자+숫자를 포함한 8자 이상",
  StringRes.passwordError: "8자 이상의 비밀번호를 입력하세요.",
  ...
  StringRes.phoneNumberError: "바른 번호 양식을 입력해주세요.",
  StringRes.name: "이름",
  ...
  StringRes.birthHint: "HH/MM/DD",
  StringRes.birthError: "바른 생년월일을 입력해주세요. 예) 19971018",
  StringRes.gender: "성별",
  StringRes.male: "남자",
  StringRes.female: "여자",
