...
final enUs = {
  ...
  StringRes.emailError: "Please enter a valid email format.",
  StringRes.emailDuplicated: "This email is already registered.",
  ...
  StringRes.passwordNotMatched: "The password does not match.",
  ...
  StringRes.birthHint: "DD/MM/HH",
  StringRes.birthError: "Please enter a valid date of birth. Example: 10181998.",
